    ...
    return useQuery({
        ...
        queryFn: async () => {
            try {
                ...
                searchParams.append('fields', JSON.stringify(['title', 'description', 'rating','customer', 'scheduled_date', 'handyman', 'status', 'completion_photos', 'customer_signature', 'notes', 'installation_fare', 'name']));
